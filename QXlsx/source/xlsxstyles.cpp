...
QColor Styles::getColorByIndex(int idx)
{
    if (m_indexedColors.isEmpty()) {
        m_indexedColors = {
            ...
            QColor(0, 0, 255), QColor(255, 255, 0),
            QColor(255, 0, 255), QColor(0, 255, 255),
            QColor(128, 0, 0), QColor(0, 128, 0),
            QColor(0, 0, 128), QColor(128, 128, 0),
            QColor(128, 0, 128), QColor(0, 128, 128),
            QColor(192, 192, 192), QColor(128, 128, 128),
            QColor(153, 153, 255), QColor(153, 51, 102),
            QColor(255, 255, 204), QColor(204, 255, 255),
            QColor(102, 0, 102), QColor(255, 128, 128),
            QColor(0, 102, 204), QColor(204, 204, 255),
            QColor(0, 0, 128), QColor(255, 0, 255),
            QColor(255, 255, 0), QColor(0, 255, 255),
            QColor(128, 0, 128), QColor(128, 0, 0),
            QColor(0, 128, 128), QColor(0, 0, 255),
            QColor(0, 204, 255), QColor(204, 255, 255),
            QColor(204, 255, 204), QColor(255, 255, 153),
            QColor(153, 204, 255), QColor(255, 153, 204),
            QColor(204, 153, 255), QColor(255, 204, 153),
            QColor(51, 102, 255), QColor(51, 204, 204),
            QColor(153, 204, 0), QColor(255, 204, 0),
            QColor(255, 153, 0), QColor(255, 102, 0),
            QColor(102, 102, 153), QColor(150, 150, 150),
            QColor(0, 51, 102), QColor(51, 153, 102),
            QColor(0, 51, 0), QColor(51, 51, 0),
            QColor(153, 51, 0), QColor(153, 51, 102),
            QColor(51, 51, 153), QColor(51, 51, 51),
        };
        m_isIndexedColorsDefault = true;
    }
